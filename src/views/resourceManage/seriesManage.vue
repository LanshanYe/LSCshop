  ...
  <div>
    <query ref="querycomponent" :list-query="listQuery" :dialog-width="'1000px'" :api="api">
      <div slot="queryFilter">
        <el-input :placeholder="$t('table.kindname')" v-model="listQuery.name" size="small" style="width: 200px;" clearable class="filter-item" @keyup.enter.native="handleFilter"/>
      ...
      <el-table-column slot="tableColumn" :label="$t('table.kindname')" prop="name"/>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" width="600px">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="right" label-width="120px" style="width: 100%;">
        <el-form-item :label="$t('table.kindname')">
